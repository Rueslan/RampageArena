...
namespace Assets.Scripts.Player
{
    public class PlayerAnimator : MonoBehaviour, IAnimationStateReader
    {
        ...
        private static readonly int AttackHash = Animator.StringToHash("Throw");
        private static readonly int HitHash = Animator.StringToHash("Hit");

        private readonly int _idleStateHash = Animator.StringToHash("Idle");
        private readonly int _idleStateFullHash = Animator.StringToHash("Base Layer.Idle");
        private readonly int _attackStateHash = Animator.StringToHash("Attack.Throw");
        ...
        private void Update()
        {
            _animator.SetFloat(MoveHash, _playerMovement.MoveDirection.magnitude, 0.1f, Time.deltaTime);
        }
